  ...
  return (
    <Box sx={{ position: "relative" }}>
      ...
      >
        ...
        <Box
          sx={{
            opacity: aiDiffState === "delete" ? (isReadOnly ? 0.4 : 0.6) : 1,
          ...
          >
            <Tooltip title="Drag to reorder" placement="top">
              <IconButton
                ...
                sx={{
                  cursor: dragHandleRef && !isReadOnly ? "grab" : "default",
                }}
                disabled={isReadOnly}
              >
                <DragIndicatorIcon
            ...
            <FormControl size="small">
              <Select
                ...
                renderValue={(selected) => {
                  const meta = QUESTION_TYPE_META.find(
                    (m) => m.type === selected,
                  );
          ...
          <Stack spacing={isSectionDivider ? 2 : 1.5}>
            ...
            {isRichTextEditable ? (
              <RichTextEditor
                ...
                onChange={(value) =>
                  queueQuestionUpdate({ description: value })
                }
                placeholder={
                  isSectionDivider
            ...
            {displayQuestion.type === "yes_no" ? (
              <Box sx={{ display: "flex", gap: 1 }}>
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    queueQuestionUpdate({ noLabel: e.target.value })
                  }
                  label="No label"
                  fullWidth
                  InputProps={{ readOnly: isReadOnly }}
